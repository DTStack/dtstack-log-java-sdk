...
public class BatchGetLogRequest extends Request {
	 ...
	 * 			  loggroup num
	 */
	public BatchGetLogRequest(String logStore, int shardId, int count, String cursor) {
	 ...
	 *            the end cursor
	 */
	public BatchGetLogRequest(String logStore, int shardId, int count, String cursor, String end_cursor) {
		this.mLogStore = logStore;
		this.mShardId = shardId;
		SetCursor(cursor);
