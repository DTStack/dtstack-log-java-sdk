 ...
 */
package com.dtstack.openservices.log.request;
...
import com.dtstack.openservices.log.common.Consts.CompressType;
import com.dtstack.openservices.log.common.TagContent;
...
public class PutLogsRequest extends Request {
	 ...
	 * 			  hashKey
	 */
	public PutLogsRequest(String logStore, String topic,
	 ...
	 *            log data
	 */
	public PutLogsRequest(String logStore, String topic, String source, List<LogItem> logItems) {
		mLogStore = logStore;
		mTopic = topic;
		mSource = source;
		mlogItems = new ArrayList<LogItem>(logItems);
	 ...
	 */
	public PutLogsRequest(String logStore, String topic,
						  String source, byte[] logGroupBytes) {
		mLogStore = logStore;
		mTopic = topic;
		mSource = source;
